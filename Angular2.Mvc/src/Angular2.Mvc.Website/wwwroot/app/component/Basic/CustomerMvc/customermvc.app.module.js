System.register(['@angular/core', '@angular/forms', '@angular/platform-browser', '@angular/http', './customermvc.app.comp', './customermvc.list.comp', './customermvc.create.comp', './customermvc.edit.comp', './customermvc.route', '../../../pipe/sanitizeHtml.pipe'], function(exports_1, context_1) {
    ...
    var core_1, forms_1, platform_browser_1, http_1, customermvc_app_comp_1, customermvc_list_comp_1, customermvc_create_comp_1, customermvc_edit_comp_1, customermvc_route_1, sanitizeHtml_pipe_1;
    var CustomerMvcAppModule;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
