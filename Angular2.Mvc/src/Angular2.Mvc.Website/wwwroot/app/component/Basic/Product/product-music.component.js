System.register(["@angular/core", "@angular/router", "@ngrx/store", "./product.service", "ng2-toastr/ng2-toastr"], function (exports_1, context_1) {
    ...
    var core_1, router_1, store_1, product_service_1, ng2_toastr_1, ProductMusicComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ProductMusicComponent = (function () {
                function ProductMusicComponent(router, productService, store, toastr, vRef) {
                    this.router = router;
                ...
                ProductMusicComponent.prototype.initMusic = function () {
                    ...
                    this.productService.getMusic().then(function (data) {
                        ...
                        _this.shopcart.subscribe(function (cart) {
                            _this.music.forEach(function (item) {
